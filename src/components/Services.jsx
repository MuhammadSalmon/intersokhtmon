...
const services = [
  ...
  { name: 'МАТЕРИАЛЬНО ТЕХНИЧЕСКАЯ БАЗА', description: 'ООО «Интерсохтмон» имеет собственную материально-техническую базу и автотранспорт различных типов в городе Рогун в том числе:', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
  ...
  return (
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-orange-400 mb-4 animate-fade-in">Our Services</h2>
